    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? "h-12 border-b border-primary/15 backdrop-blur-xl"
            : "h-14 backdrop-blur-md"
        }`}
        style={{
          background: scrolled
            ? 'linear-gradient(180deg, hsl(213 99% 50% / 0.08) 0%, hsl(213 99% 50% / 0.04) 100%)'
            : 'linear-gradient(180deg, hsl(213 99% 50% / 0.05) 0%, hsl(213 99% 50% / 0.01) 100%)',
        }}
      >
