            ...
            <div className="flex flex-col md:flex-row" style={{ minHeight: 440 }}>
              ...
              <div className="flex-1 overflow-y-auto p-6">
                ...
                <div className="mt-4 space-y-0">
                  {constraints.map((c) => (
                    <div key={c.name} className="flex items-center justify-between border-b border-border/60 py-3">
                      <div>
                ...
                <h4 className="mt-5 text-[13px] font-semibold text-foreground">Metrics</h4>
                <div className="mt-3 grid grid-cols-2 gap-2.5 pb-4">
                  {metricTiles.map((m) => (
                    <div key={m.label} className="rounded-lg border border-border p-3.5 transition-all duration-200 hover:border-primary/20 hover:shadow-sm" style={{ background: "#FAFAF9" }}>
