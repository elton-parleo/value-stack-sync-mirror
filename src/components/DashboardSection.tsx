...
const DashboardSection = () => {
  ...
  return (
    <AnimatedSection id="dashboard" className="section-grid relative bg-background py-10 md:py-14" ref={ref}>
      ...
      <div className="pointer-events-none absolute left-0 bottom-[5%] h-[250px] w-[160px] overflow-hidden opacity-[0.03] blur-[5px] md:h-[400px] md:w-[280px] md:opacity-[0.04]">
