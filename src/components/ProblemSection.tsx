  ...
  return (
    <AnimatedSection id="problem" className="section-grid relative bg-background py-10 md:py-14" ref={ref}>
      ...
      <div className="mx-auto max-w-content px-6 md:px-20">
        ...
        {/* Toggle */}
        <div className="mt-5 inline-flex items-center gap-1 rounded-full border border-border bg-card p-1" style={{ boxShadow: 'var(--shadow-sm)' }}>
          <button
          ...
          <button
            ...
            className={`rounded-full px-4 py-2 text-[14px] font-medium transition-all ${
              showParleo
                ? "bg-accent-warm/15 text-accent-warm border border-accent-warm/30 shadow-sm"
                : "text-foreground/40 hover:text-foreground/60"
            }`}
          >
            With Parleo
