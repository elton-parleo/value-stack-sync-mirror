...
const DemoHero = ({ onRequestAccess }: Props) => {
  return (
    <section className="relative overflow-hidden bg-background pb-4 pt-8 md:pt-12">
      ...
      <div className="mx-auto max-w-content px-5 md:px-20">
        ...
        >
          ...
          <h1 className="font-display text-[40px] text-foreground md:text-[60px]" style={{ lineHeight: 1.08, letterSpacing: '-0.04em' }}>
            Agents that shop with your advantages.
          </h1>
          <p className="mt-4 max-w-[520px] text-[16px] leading-[1.7] text-foreground/65 md:text-[17px]">
