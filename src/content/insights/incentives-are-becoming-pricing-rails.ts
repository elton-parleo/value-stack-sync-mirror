...
const post: Post = {
  ...
  body: [
    { type: "p", text: "Incentives used to sit comfortably on the marketing line: points, member pricing, card-linked offers, subscription discounts. Brands funded them to change behavior and booked them as a cost of doing business." },
    { type: "p", text: "Now those same incentives are becoming pricing infrastructure. They may be the last lever that protects margin without torching MAP or racing everyone to the bottom on list price." },
    ...
    { type: "p", text: "We asked ChatGPT what the bag costs. The answer came back quickly: $19.99. True, but also the worst of the four prices on the page. Everything Chewy built to trade margin for lifetime value sat one rung below the number the agent quoted." },
    ...
    { type: "p", text: "That money still works when a person reaches the page. The open question is whether it survives the trip into an agent's answer. Brands that make the member price and the deal legible can protect margin while still rewarding the customer they already paid to acquire." },
  ],
};
