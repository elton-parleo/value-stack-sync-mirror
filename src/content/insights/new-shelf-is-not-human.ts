...
const post: Post = {
  ...
  body: [
    { type: "p", text: "E-commerce is being rebuilt for a customer that isn't human." },
    { type: "p", text: "And shoppers are already treating AI that way. 46% of AI shoppers use it to compare prices and find deals." },
    { type: "p", text: "Here's the catch: nearly every price in a ChatGPT comparison table is a list price. No member price, no card-linked offer, no loyalty math. Just the number sitting at the top of the page." },
    ...
    { type: "p", text: "Twenty years of PDPs, banners, badges and urgency copy, all of it tuned to move a person. Now the same catalog is being rebuilt for agents that read feeds and APIs and skip almost all of that work." },
    { type: "p", text: "Watch how big tech behaves and you can see it. OpenAI launched Instant Checkout last fall and killed it by March. Walmart put 200,000 products in, saw conversion run about three times worse than its own site, pulled them, and rebuilt inside its own walls, where its agent can see your membership, your promotions, your fulfillment. It's now posting 35% bigger baskets." },
    ...
    { type: "p", text: "Trade spend funds the offers, rewards and discounts brands run at retail. Retail media buys the banners and sponsored listings on top. Agents skip both. They don't see the banner, and they can't read the deal you funded." },
    { type: "p", text: "What survives the trip from your pricing stack into the agent's answer: that's the gap we've spent the last 6 months building for." },
    { type: "h", text: "A simple test" },
    { type: "p", text: "We asked ChatGPT to find the best price on a Patagonia Down Sweater Hoody. It picked the cheaper list price. Factor in the member benefits and funded offers it couldn't see, and the more expensive retailer was the better deal." },
    { type: "p", text: "Worth sitting with, if the customers getting those offers are your best ones." },
  ],
};
