...
const post: Post = {
  ...
  body: [
    ...
    { type: "p", text: "Shoppers are already behaving as if the rebuild happened. 46% of AI shoppers use it to compare prices and find deals." },
    ...
    { type: "p", text: "We've spent the last six months working on one gap: what survives the trip from your pricing stack into the agent's answer." },
