...
const MobileCustomerDeck = () => (
  <div className="bg-background md:hidden">
    ...
    <Frame number="A1">
      ...
      <FounderVisual initials="SB" role="Co-founder & CEO" name="Samar Birwadker" companies={["Landor","WPP","Axel Springer","Nike","Xbox"]} />
      ...
      <FounderVisual initials="EC" role="Co-founder & CTO" name="Elton Cheung" companies={["Rakuten","Groupon","AlphaFlow"]} dark />
